...
import EditPrd from '../Form/Prd/editPrd';   // componente de editar
import AddPrd from '../Form/Prd/addPrd';     // componente de adicionar
...
const ListaProdutos = () => {
  ...
  useEffect(() => {
    // aqui pode carregar dados iniciais (mock ou API)
  }, []);
